...
// Tis script checks if the user is standing in a given position for three seconds, and then it calls a method (start or quit)

public class StartQuitTrigger : MonoBehaviour
{
